...
def get_args_parser():
    ...
    parser.add_argument('--masks', action='store_true',
                        help="Train segmentation head if the flag is provided")
    # HOI
    parser.add_argument('--pretrained', type=str, default="/network_space/server128/shared/xuzhu/swin_tiny_patch4_window7_224.pth",
                        help='Pretrained model path')
    # parser.add_argument('--pretrained', type=str, default="/home/xuzhu/interactdiffusion/FGAHOI/swin_large_patch4_window12_384_22k.pth",
    #                     help='Pretrained model path')
    ...
    parser.add_argument('--hoi_path', default='/home/xuzhu/interactdiffusion/DATA/hico_20160224_det', type=str)
    ...
    parser.add_argument('--base', action='store_true',
                        help="base set.")
    parser.add_argument('--hierarchical_merge', action='store_false',
                        help="switch for hierarchical_merge.")
    parser.add_argument('--task_merge', action='store_false', 
                        help="switch for task_merge.")                            

    # Traing utils
    parser.add_argument('--output_dir', default='logs/id-generated-output-t', help='path where to save, empty for no saving')
    parser.add_argument('--note', default='', help='add some notes to the experiment')
    parser.add_argument('--device', default='cuda', help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default="/home/xuzhu/interactdiffusion/FGAHOI/FGAHOI_Tiny.pth", help='resume from checkpoint')
    parser.add_argument('--pretrain_model_path', help='load from other checkpoint')
    parser.add_argument('--finetune_ignore', type=str, nargs='+', 
                        help="A list of keywords to ignore when loading pretrained models.")
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--eval', action='store_false', help="eval only. w/o Training.")
