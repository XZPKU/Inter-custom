    ...
    for anno_item in anno_info:
        ...
        for hoi_instance in hoi_annotation:
            try:
                ...
                caption_path = os.path.join(image_info_path,'llava_caption.txt')
                with open(caption_path,'r') as f:
                    cap = f.read()
                sto_info = {}
                sto_info['image_name'] = f'{image_name}_{hoi_instance_num}'
                sto_info['llava_caption'] = cap
                #sto_info['hoi_mask'] = union_mask_3.tolist()
                #sto_info['fore_appearance'] = fore_hoi.tolist()
                ...
                # with open('/network_space/server128/shared/zhuoying/AnyDoor-main/datasets/mask_storage_test.json','w') as f:
                #     json.dump(all_mask_sotrage,f)
            except:
                print(f'finish {image_name}_{hoi_instance_num}') 
    
    with open('/network_space/server128/shared/zhuoying/AnyDoor-main/datasets/mask_storage_v2.json','w') as f:
        json.dump(all_mask_sotrage,f)
