...
def generate_caption(args):
    ...
    for anno_item in anno_info:
        ...
        for hoi_instance in hoi_annotation:
            try:
                ...
                #query = f'There is {hoi_prompt[11:]}, please use three sentences to seperately describe (1) the haircut, body shape and appearance of person,(2) the shape and appearance of object,(3) the scenario of thorough human object interaction. Following is a example: The person is a short hair, tall and thin man, and wearing a hat. The bicycle is a colorful mountain bicycle. The man riding the bicycle with a hand waving in the air.'
                query = f'There is {hoi_prompt[11:]}, please use two sentence to describe (1) the spatial configuration between the them (2) the pose of human. Following is a example: The biclycle is on the right of human, closely near the human, and there is a large overlap between them. The person is standing straightly, with one hand waving in the air.'
                ...
                with open(os.path.join(image_info_path,'llava_caption_spatial.txt'),'w') as f:    #设置文件对象
                    f.write(outputs)  
    ...
    with open('/network_space/server128/shared/zhuoying/AnyDoor-main/datasets/mask_storage_v3.json','w') as f:
