...
def generate_caption(args):
    ...
    hico_image_path = '/home/xuzhu/MoMA/data/process_data'
    ...
    #     all_mask_sotrage[i] = []
    ans_file_path = '/network_space/server128/shared/zhuoying/AnyDoor-main/datasets/all_llava_hico_train.json'
    ...
    for anno_item in tqdm(anno_info):
        ...
        try:
            img = Image.open(os.path.join('/home/xuzhu/MoMA/data/hico_20160224_det/images/train2015', image_name)).convert('RGB')
            w, h = img.size
            img_anno = anno_item
