...
def generate_caption(args):
    ...
    obj_img = Image.open('/network_space/server128/shared/zhuoying/AnyDoor-main/hoi_samples/golden.jpg')
    ...
    query = f'There is a person and a dog, please use three sentences to seperately describe (1) the haircut, body shape and appearance of person,(2) the shape and characteristic of dog (e.g., the brand, the ear shape, etc). (3) The desired spatial configuration for human petting a dog, like the human should be left close to the dog, etc'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--target_hoi_category",type = int,default=121,required=False)
