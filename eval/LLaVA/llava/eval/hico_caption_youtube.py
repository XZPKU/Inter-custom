...
def generate_caption(args):
    ...
    category_video_name = os.listdir('/network_space/server128/shared/zhuoying/AnyDoor-main/taobao_more_category')
    for cat_name in category_video_name:
    
        cat_dir = os.path.join('/network_space/server128/shared/zhuoying/AnyDoor-main/taobao_more_category',f'{cat_name}')
